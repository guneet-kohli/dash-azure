...
import pandas as pd
pd.set_option('max_rows',20) #max rows displayed is 20
...
DEAD_URL = 'https://raw.githubusercontent.com/CSSEGISandData/COVID-19/master/csse_covid_19_data/csse_covid_19_time_series/time_series_covid19_recovered_global.csv'
RECV_URL = 'https://raw.githubusercontent.com/CSSEGISandData/COVID-19/master/csse_covid_19_data/csse_covid_19_time_series/time_series_covid19_deaths_global.csv'
...
#getting data in cleaned time series format for country
...
# #  SUMMING  UP TO GET TOTAL COUNT WORLDWIDE FOR THE THREE CASES

# In[10]:


#getting overall wordlwide total for confirmed, recovered and dead cases
def get_overall_total(df):
    return df.iloc[:,-1].sum() #here -1 is used as it selects the last column in df because that is how division of files was done
...
# # Performing country-wise data cleaning and generating a line graph
...
USERNAME_PASSWORD_PAIRS=[['username','password'],['Guneet-Kohli','1234']]
...
def get_page_heading_subtitle():
    return html.Div(children='Visualizing Covid-19 data generated from sources all over the world over the selected period. ',
                                         style={
                                             'textAlign':'center',
                                             'color':colors['text']
                                         })
...
# # Creating a dropdown list for every unique country
